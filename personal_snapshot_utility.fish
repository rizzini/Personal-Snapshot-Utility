...
complete -c personal_snapshot_utility -f -n "__fish_seen_argument --root" -l help -s h -d "Show help and exit"
complete -c personal_snapshot_utility -f -n "__fish_seen_argument --home" -l help -s h -d "Show help and exit"
...
complete -c personal_snapshot_utility -f -n "__fish_seen_argument --root; and not __fish_seen_argument --run; and not __fish_seen_argument --dry-run" \
    -a "--run --dry-run" -d "Choose execution mode"
complete -c personal_snapshot_utility -f -n "__fish_seen_argument --home; and not __fish_seen_argument --run; and not __fish_seen_argument --dry-run" \
    -a "--run --dry-run" -d "Choose execution mode"

complete -c personal_snapshot_utility -f -n "__fish_seen_argument --dry-run; and __fish_seen_argument --root" \
    -a "--list-files" -d "List files that would be copied (dry-run only)"
complete -c personal_snapshot_utility -f -n "__fish_seen_argument --dry-run; and __fish_seen_argument --home" \
    -a "--list-files" -d "List files that would be copied (dry-run only)"

complete -c personal_snapshot_utility -f -n "__fish_seen_argument --run; and __fish_seen_argument --root; and not __fish_seen_argument --progress-file; and not __fish_seen_argument --progress-bar" \
    -a "--progress-bar" -d "Show aggregate progress bar (only with --run)"
complete -c personal_snapshot_utility -f -n "__fish_seen_argument --run; and __fish_seen_argument --home; and not __fish_seen_argument --progress-file; and not __fish_seen_argument --progress-bar" \
    -a "--progress-bar" -d "Show aggregate progress bar (only with --run)"
...
complete -c personal_snapshot_utility -f -n "__fish_seen_argument --run; and __fish_seen_argument --root; and not __fish_seen_argument --snapshot_suffix; and not string match -r -- '--snapshot_suffix=.*' (commandline -opc)" \
    -a "--snapshot_suffix=" -r -d "Add a suffix to the snapshot name (use with --run)"
complete -c personal_snapshot_utility -f -n "__fish_seen_argument --run; and __fish_seen_argument --home; and not __fish_seen_argument --snapshot_suffix; and not string match -r -- '--snapshot_suffix=.*' (commandline -opc)" \
    -a "--snapshot_suffix=" -r -d "Add a suffix to the snapshot name (use with --run)"
